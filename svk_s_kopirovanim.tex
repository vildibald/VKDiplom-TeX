...
Vysvetlenie pojmu splajn, De Boorvho modeu vıpoètu derivácií a návrh zrıchlenia tohto modelu pre rovnomerné mrieky uzlov.
...
%Nišie si ukáeme optimalizovanı pseudokód tohto algoritmu prevzatı z \cite{lu_c} a modifikovanı pre naše sústavy rovníc v tvare pre plnı redukovanı algoritmus o ktorıch si povieme v následujúcich èastiach.
...
V rámci tohto èlánku budeme uvaova len sériovú implementáciu.
\end{pozn}
...
Pri LU dekompozícii môeme vidie, e toto neplatí. 
...
V tejto èasti si spoèítame poèty operácií procedúr tvoriacich plnı a redukovanı algoritmus, ktorıch èasová zloitos je rovnaká a síce $O(I\cdot J)$.
...
V èasti \ref{sec:spup} si ukáeme, e redukovanı algoritmus je po aplikovaní vplyvu inštrukèného paralelizmu a cien za operácie delenia a kopírovania skutoène rıchlejší. 
...
Podarilo sa nám v prípade rovnomerne rozloenıch uzlov urıchli sériovı vıpoèet derivácií splajnov v uzloch. 
...
Ïalšou vıhodou sú polovièné pamäové nároky èo umoòuje rieši väèšie úlohy. 
