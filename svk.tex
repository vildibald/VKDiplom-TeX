...
V èasti \ref{sec:spup} si ukáeme, e redukovanı algoritmus je po aplikovaní vplyvu inštrukèného paralelizmu a ceny za operácie delenia skutoène rıchlejší. 
...
$$\frac{21+3\gamma}
	{\rfrac{25}{4} + \rfrac{57}{2\beta} + \rfrac{5}{4}\cdot \gamma}$$ 
\end{veta}
